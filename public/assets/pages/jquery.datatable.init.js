...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        var e = $("#child_rows").DataTable({
            data: testdata.data,
            select: "single",
            columns: [{ className: "details-control", orderable: !1, data: null, defaultContent: "" }, { data: "name" }, { data: "position" }, { data: "office" }, { data: "salary" }],
            order: [[1, "asc"]],
        });
...
var testdata = {
    data: [
        ...
        { name: "Garrett Winters", position: "Accountant", salary: "$170,750", start_date: "2011/07/25", office: "Tokyo", extn: "8422" },
        { name: "Ashton Cox", position: "Junior Technical Author", salary: "$86,000", start_date: "2009/01/12", office: "San Francisco", extn: "1562" },
    ],
};
