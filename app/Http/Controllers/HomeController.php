...
//        $renewal = Card::where('status','renewal')->count();
        ...
        $today_price = Card::wherePaid(1)->whereDate('issue_date', Carbon::today())->sum('price');
    ...
    public function arLang(){
        ...
        $lang['sub_heading'] = 'عضوية سنوية تمنحك خصومات فورية على معظم الخدمات الطبية والتجميلية من ضمن مجموعة واسعة من المستشفيات والعيادات الخاصة المتعاقدة مع سما بحرين كارد';
        return $lang;
    }
}
