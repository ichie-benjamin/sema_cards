                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group "><label>Provider name</label>
                                                        <input required name="ar_provider_name" value="{{ old('ar_provider_name', $hospital->ar_provider_name) }}" type="text" class="form-control" placeholder="provider_name" />
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group "><label>Address (Bld/house / Flat / Road , Block , Place , Country)</label>
                                                        <input  value="{{ old('ar_address', $hospital->ar_address) }}" name="ar_address" type="text" class="form-control" placeholder="address" />
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group "><label>Place </label>
                                                        <input  value="{{ old('ar_place', $hospital->ar_place) }}" name="ar_place" type="text" class="form-control" placeholder="ar_place" />
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group"><label>Description </label>
                                                        <textarea class="form-control" name="ar_description">{{ old('ar_description', $hospital->ar_description) }}</textarea>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group"><label>Comment </label>
                                                        <textarea class="form-control" name="ar_comment">{{ old('ar_comment', $hospital->ar_comment) }}</textarea>
